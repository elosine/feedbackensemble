...
int p[NP] = { A0, A1,A2,A3,A4,A5,A6,A7 }; //analog input pins
int pv[NP];//pot value
int ppv[NP] = {0,0,0,0,0,0,0,0}; //previous pot value

//buttons
//int nb = 6;
int b[] = { 2, 3,4,5,6,7 }; //digital input pins
boolean bg[] = {true, true, true, true, true,true};//momentary button gates
////button toggle
int btv[] = { 0, 0,0,0,0,0}; //toggle button current value
int btamt[] = {2,2,2,2,2,2}; //number of toggles
boolean btg[] = {true, true, true, true, true,true};//toggle button gates
